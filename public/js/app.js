...
window.populate_data_wallboard = function () {
  $.ajax({
    ...
    success: function success(data) {
      console.log(data);
      Object.entries(data.singleNum).forEach(function (_ref) {
...
/******/ __webpack_require__.O(0, ["css/app","css/vendor","/js/vendor"], () => (__webpack_exec__("./resources/js/app.js"), __webpack_exec__("./resources/sass/vendor.scss"), __webpack_exec__("./resources/sass/app.scss"), __webpack_exec__("./resources/css/app.css")));
